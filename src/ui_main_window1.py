...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.start_bt.setGeometry(QtCore.QRect(270, 550, 331, 23))
        self.start_bt.setObjectName("start_bt")
        self.songVolumeSlider = QtWidgets.QSlider(self.centralwidget)
        self.songVolumeSlider.setGeometry(QtCore.QRect(50, 550, 160, 22))
        ...
        self.checkBox_MIDI.setGeometry(QtCore.QRect(770, 550, 70, 17))
        self.checkBox_MIDI.setObjectName("checkBox_MIDI")
        self.checkBox_Arduino = QtWidgets.QCheckBox(self.centralwidget)
        self.checkBox_Arduino.setGeometry(QtCore.QRect(680, 550, 70, 17))
        ...
        self.stream_label = QtWidgets.QLabel(self.centralwidget)
        self.stream_label.setGeometry(QtCore.QRect(1240, 520, 151, 21))
        ...
        self.stream_label_2 = QtWidgets.QLabel(self.centralwidget)
        self.stream_label_2.setGeometry(QtCore.QRect(380, 520, 131, 20))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.stream_label_2.sizePolicy().hasHeightForWidth())
        self.stream_label_2.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.stream_label_2.setText(_translate("MainWindow", "Color Stream"))
