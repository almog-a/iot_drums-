...
class Drums:
    ...
    def __init__(self, pixel_ratio=3.7):#3.7 from a distance of 1.5 m
        ...
        self.drum3_points = self.calculate_drum_size(500, 280)
        self.drum4_points = self.calculate_drum_size(700, 280)
    ...
    def get_locations(self):
        return dict(hihat_points=self.hihat_points, snare_points=self.snare_points, kick_points=self.kick_points)
